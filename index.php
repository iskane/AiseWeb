<?php get_header(); ?>
    ...
    <div class="container">
        ...
        <div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; width: 1140px; height: 442px; overflow: hidden;">
            ...
            overflow: hidden;">
                <div>
                    <img u="image" src2="<?php bloginfo('template_url'); ?>/img/home/01.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?php bloginfo('template_url'); ?>/img/home/02.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?php bloginfo('template_url'); ?>/img/home/03.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?php bloginfo('template_url'); ?>/img/home/04.jpg" />
                </div>
            </div>
...
<!---------------------------- Recuperación informaciones de los posts---------------------->
